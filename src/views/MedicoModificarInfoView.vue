  ...
  <main>
    <form class="formulario text-center" @submit.prevent="validarInfo()">
      ...
      <div>
        ...
        <input class="form-control" type="time" name="inputHorarioInicioAtencion" v-model="horarioInicioAtencion">
      </div>

      <div>
        <label for="inputHorarioFinAtencion" class="form-label">Horario de Fin de Atención</label>
        <input class="form-control" type="time" name="inputHorarioFinAtencion" v-model="horarioFinAtencion">
      </div>
